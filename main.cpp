...
int main()
{
	...
	do
	{
		...
		try
		{
			...
			//Perform each action depending on user input
			...
			else if(command=="find_max") 				cout<<"The word with the heighest frequency is "<<myHashTable.find_Max().first << " with frequency " << myHashTable.find_Max().second <<endl;
